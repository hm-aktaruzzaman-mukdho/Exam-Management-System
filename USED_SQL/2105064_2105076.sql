...
CREATE TABLE QUESTION (
    ...
    IS_DELETED NUMBER DEFAULT 0 CHECK(IS_DELETED=0 OR IS_DELETED =1),
...
CREATE TABLE EXAM (
    ...
    QUESTION_SET_ID NUMBER,
    EXAM_TIME DATE,
     -- New: Added attribute for the exam time
    --EXAM_DATE DATE,
...
CREATE TABLE ASSIGNMENT (
    ...
    ASSIGNMENT_FILE BLOB, --may have to change this later to use file path in the databse instead of storing actudal file
...
CREATE TABLE ASSIGNMENT_SUBMISSION (
    ...
    DEFAULT CURRENT_DATE,
     -- New: Added submission time with default value
