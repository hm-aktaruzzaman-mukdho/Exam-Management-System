...
CREATE TABLE PROCEDURE_FUNCTION_LOG (
    ...
    CALL_DATETIME DATE DEFAULT CURRENT_DATE,
...
CREATE TABLE QUESTION_SET (
    ...
    ACCESSIBILITY_LEVEL VARCHAR2(50) DEFAULT 0,
...
CREATE TABLE EXAM (
    ...
    SCHEDULED_BY NUMBER,
    QUESTION_SET_ID NUMBER,
    EXAM_TIME DATE, -- New: Added attribute for the exam time
    --EXAM_DATE DATE,
...
CREATE TABLE ASSIGNMENT (
    ...
    ASSIGNMENT_FILE VARCHAR2(1000), --may have to change this later to use file path in the databse instead of storing actudal file
...
CREATE TABLE ASSIGNMENT_SUBMISSION (
    ...
    SUBMISSION_TIME DATE DEFAULT CURRENT_DATE, -- New: Added submission time with default value
...
/*
CREATE TABLE TEMP_RANDOM_QUESTION_SET(
    TEACHER_ID NUMBER,
    QUESTION_ID NUMBER,
    PRIMARY KEY (QUESTION_SET_ID, QUESTION_ID),
    FOREIGN KEY (QUESTION_SET_ID) REFERENCES QUESTION_SET(QUESTION_SET_ID) ON DELETE CASCADE,
